...
Management (TTM) Workgroup was established in 2014 under the Unit for Pre-hospital
...
various healthcare institutions and across different specialities, the
workgroup has developed local post-cardiac arrest guidelines based on the
latest evidence, conducted local research projects, collaborated with international
resuscitation organisations, and held numerous educational courses for
...
July 2017.</p>
<p>Recognising the growing importance of post-resuscitation care for cardiac
...
<p>The workgroup comprises representatives from the following specialities
